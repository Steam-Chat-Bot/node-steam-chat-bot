...
// You can also pass in a steam guard code from an email or totp code from steam mobile.
var myBot = new ChatBot("username", "password", {
	twoFactorAuth:    "dI5Bx",
	//If you prefer to programmatically generate the 2FA code rather than entering it manually (good for auto-reconnect), you
	//may instead present a function that returns the 2FA code as a 5-character string. You can get the shared_secret from WinAuth.
	//twoFactorAuth:    function(){return require('steam-totp').generateAuthCode('cnOgv/KdpLoP6Nbh0GMkXkPXALQ=')},
	//twoFactorAuth:    function(){return require('steam-totp').generateAuthCode(fs.readFileSync('./private/shared_secret.bin')},
