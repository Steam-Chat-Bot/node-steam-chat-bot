...
options: {
  ...
  defaults: { //default settings everywhere
    ircOptions: {  //this object will be passed into the irc object without checking it,
			  						other than sane defaults for the specific items below.
		  							Full options are available at https://node-irc.readthedocs.org/en/latest/API.html#internal
