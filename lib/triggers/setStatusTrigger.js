...
SetStatusTrigger.prototype._respond = function(toId, message) {
		...
		if(trigger.options.statuses.offline!=false && query == trigger.options.statuses.offline){ this.chatBot.steamClient.setPersonaState(0); return true; }
		if(trigger.options.statuses.online !=false && query == trigger.options.statuses.online) { this.chatBot.steamClient.setPersonaState(1); return true; }
		if(trigger.options.statuses.busy   !=false && query == trigger.options.statuses.busy)   { this.chatBot.steamClient.setPersonaState(2); return true; }
		if(trigger.options.statuses.away   !=false && query == trigger.options.statuses.away)   { this.chatBot.steamClient.setPersonaState(3); return true; }
		if(trigger.options.statuses.snooze !=false && query == trigger.options.statuses.snooze) { this.chatBot.steamClient.setPersonaState(4); return true; }
		if(trigger.options.statuses.trade  !=false && query == trigger.options.statuses.trade)  { this.chatBot.steamClient.setPersonaState(5); return true; }
		if(trigger.options.statuses.play   !=false && query == trigger.options.statuses.play)   { this.chatBot.steamClient.setPersonaState(6); return true; }
		return false;
}
