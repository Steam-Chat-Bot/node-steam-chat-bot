...
ChatReplyTrigger.prototype._messageTriggers = function(toId, message, fromId) {
	...
	if (!this._checkRoom(toId)) {
		return false;
	}

	if (this._checkIgnores(toId,fromId)) {
		return false;
	}
...
ChatReplyTrigger.prototype._checkIgnores = function(toId, fromId) {
...
ChatReplyTrigger.prototype._checkRoom = function(toId) {
