...
ChatReplyTrigger.prototype._respond = function(toId, message, fromId) {
	if (this._messageTriggers(message, fromId)) {
...
ChatReplyTrigger.prototype._messageTriggers = function(message, fromId) {
	if (!message) {
		return false; 
	}

	if (!this._checkUser(fromId)) {
		return false;
	}
...
ChatReplyTrigger.prototype._checkUser = function(fromId) {
...
ChatReplyTrigger.prototype.getType = function() { return "ChatReplyTrigger"; }
exports.triggerType = ChatReplyTrigger.prototype.getType();
