...
locate = string - where to store the statuses on disk. Defaults to ./BOTNAME/StatusTrigger/TRIGGERNAME (if you need storages to be shared, set them to `myBot.username + '/StatusTrigger'` or some such. Putting them in '.' is a terrible idea.
*/
...
exports.create = function(name, chatBot, options) {
	...
	trigger.options.location = options.location         || (process.cwd()+"/"+chatBot.username + '/'+name);
