...
exports.create = function(name, chatBot, options) {
	...
	trigger.options.dbFile = trigger.options.hasOwnProperty('dbFile') ? trigger.options.dbFile : chatBot.username + '/' + "Pushbullet.db";
...
PushbulletTrigger.prototype._username = function(steamId) {
