...
wsURL         = string    - false                       - Only changes logging: If this doesn't work because of a proxy or some such, set the public/visible url of your server here. Use ws:// for http and ws:// for https. Set to false to not use a different url for websocket (default).
