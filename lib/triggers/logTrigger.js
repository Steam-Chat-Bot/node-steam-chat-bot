...
pingTimer     = int       - 5000                        - How often should the server ping the client? I have set the ping default to 5s instead, and am now using the built-in ping packet instead of my own packet.
