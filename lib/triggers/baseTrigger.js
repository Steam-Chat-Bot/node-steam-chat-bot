...
// Subclasses should also give themselves a unique triggerName and create function so that they can be created by the TriggerFactory
exports.BaseTrigger = BaseTrigger;
exports.triggerName = "BaseTrigger";
...
BaseTrigger.prototype._randomRoll = function() {
	if (this.options.probability) {
		...
		if (random > this.options.probability) return false;
	}
