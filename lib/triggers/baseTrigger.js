...
BaseTrigger.prototype.onChatInvite = function(roomId, roomName, inviterId) {
	if(this._checkUser(inviterId) && this._checkRoom(roomId) && this.checkIgnores(roomId,invitedId)) 
...
BaseTrigger.prototype.onFriendMessage = function(userId, message, haveSentMessage) {
	if (this.replyEnabled && this._randomRoll() && this._checkMultiResponse(haveSentMessage) && this._checkUser(userId) && !this._checkIgnores(toId, null)) {
...
BaseTrigger.prototype.onChatMessage = function(roomId, chatterId, message, haveSentMessage, muted) {
	if (this.replyEnabled && this._randomRoll() && this._checkMultiResponse(haveSentMessage) && this._checkMute(muted) && this._checkUser(chatterId) && this._checkRoom(roomId) && !this._checkIgnores(chatterId,roomId)) {
...
BaseTrigger.prototype.onEnteredChat = function(roomId, userId, muted) {
	if (this.replyEnabled && this._randomRoll() && this._checkMute(muted) && this._checkUser(userId) && this._checkRoom(roomId) && !this._checkIgnores(roomId,userId)) {
