...
GitHubWebHookTrigger.prototype._onLoad = function() {
	var that = this;
	try {
		if(!(that.options.rooms instanceof Array && that.options.rooms.length===1 && typeof that.options.rooms[0] === 'string')) {
...
GitHubWebHookTrigger.prototype._callIfEnabled = function(hook,callback) {
	var that = this;
...
GitHubWebHookTrigger.prototype._checkIfEnabled = function(hook, callback) {
