...
exports.CleverbotTrigger = CleverbotTrigger;
CleverbotTrigger.prototype.getType = function() { return "CleverbotTrigger"; }
exports.triggerType = CleverbotTrigger.prototype.getType();
exports.create = function(name, chatBot, options) {
	var trigger = new CleverbotTrigger();
	trigger.init(name, chatBot, options);
	trigger.cleverbot = trigger.options.cleverbot || new Cleverbot();
	return trigger;
};
