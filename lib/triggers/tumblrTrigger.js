...
TumblrTrigger.prototype._logResult = function(err, result, blogName) {
	if (err) {
		this.winston.info("Error posting to tumblr", err)
	}
	else if (result) {
		this.winston.info("Posted to " + "http://" + blogName + ".tumblr.com/post/" + result.id);
	}
};
...
TumblrTrigger.prototype._postPhoto = function(link, context) {
	...
	this.winston.info("Posting photo " + link + " with context " + context + " to tumblr");
	...
	this.blog.photo(this.options.blogName, postOptions, function(err, result) {
		this._logResult(err, result, that.options.blogName);
	});
...
TumblrTrigger.prototype._postNonTumblrGif = function(link, context) {
	...
	this.winston.info("Posting non-tumblr gif " + link + " with context " + context + " to tumblr");
...
TumblrTrigger.prototype._postQuote = function(post) {
	var that = this;
	this.winston.info("Posting quote to tumblr: " + post);
...
TumblrTrigger.prototype._postText = function(post) {
	var that = this;
	this.winston.info("Posting text to tumblr: " + post);

	this.blog.text(this.options.blogName, { body: post, tags: "text" }, function(err, result) {
		this._logResult(err, result, this.options.blogName);
	});
...
TumblrTrigger.prototype._postLink = function(link, context) {
	...
	this.winston.info("Posting link " + link + " with context " + context + " to tumblr");
...
TumblrTrigger.prototype._postChat = function(post) {
	this.winston.info("Posting chat to tumblr: " + post);
...
TumblrTrigger.prototype._postAudio = function(link, context) {
	...
	this.winston.info("Posting audio " + link + " with context " + context + " to tumblr");
...
TumblrTrigger.prototype._postVideo = function(link, context) {
	...
	this.winston.info("Posting video " + link + " with context " + context + " to tumblr");
