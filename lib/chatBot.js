var ver = "2.4.0"; //update this before pushing to master.
...
ChatBot.prototype._onUpdateMachineAuth = function(sentry, cb) {
		...
		fs.writeFile(this.sentryFile, sentry.bytes, e => {
			if(e) this.winston.error(e.stack);
			else this.winston.verbose('Wrote sentry file');
		});
		cb({
