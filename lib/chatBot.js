...
//	this.steamTrade = new SteamTrade
	...
	if(options.sentryFile) {
		...
		} else if(fs.existsSync('sentryfile.'+this.username))         { this.sentryFile = 'sentryfile.'+this.username;         this.log.info("Sentry file "+this.sentryFile+" detected.");
		} else if(fs.existsSync('sentryfile.'+this.username+'.hash')) { this.sentryFile = 'sentryfile.'+this.username+'.hash'; this.log.info("Sentry file "+this.sentryFile+" detected.");
