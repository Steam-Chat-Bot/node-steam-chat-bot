...
var ChatBot = function(username, password, options) {
	...
	this.steamClient.on("loggedOn",        function()       { that._onLoggedOn(); that.onLogon(that); that.triggerLoggedOn(); });
	this.steamClient.on("loggedOff",       function()       { that._onDisconnected(); that.triggerLoggedOff(); });
